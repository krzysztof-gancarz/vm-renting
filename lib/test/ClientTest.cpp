...
BOOST_AUTO_TEST_CASE(ClientFirstNameCase) {
        ...
        BOOST_REQUIRE_EQUAL(client1.getBirthDate().year_month_day().year, 1998);
        BOOST_REQUIRE_EQUAL(client1.getBirthDate().year_month_day().month, 2);
        BOOST_REQUIRE_EQUAL(client1.getBirthDate().year_month_day().day, 15);
